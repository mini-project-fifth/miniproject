    ...
    <v-container>
        ...
        <div class="panel">
            <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn :disabled="!selectedRow" style="margin-left: 5px;" @click="deductPointDialog = true" class="contrast-primary-text" small color="primary" >
                    <v-icon small>mdi-minus-circle-outline</v-icon>포인트차감
                </v-btn>
            ...
            <PointInfoCheck @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></PointInfoCheck>
